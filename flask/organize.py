...
class WorkoutDB:
    ...
    def insert_workout(self, warmup_description, warmup_movements,
        ...
        insert_query = "INSERT INTO workouts (date, warmup_description, warmup_movements, strength_description, strength_movements, wod_description, wod_movements, cooldown_description, cooldown_movements) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
        date = datetime.now().strftime("%m/%d/%y")
        data = (date, warmup_description, warmup_movements, strength_description, strength_movements, wod_description, wod_movements, cooldown_description, cooldown_movements)
        try:
...
if __name__ == "__main__": 
    ...
    warmup_movements = ["warm up movement", "b", 'c']
